...
try:
    ...
    # (R-068) Linux コールバック (_on_linux_readable / _on_linux_writable) が実装完了したため、
    # import 成功時は Windows / Linux を問わず native backend を有効化する。
    # （R-053 で設けた _sys.platform == "win32" ゲートを撤廃）
